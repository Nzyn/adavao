...
CREATE TABLE "admin_login_attempts" (
  ...
  "attempted_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP) =7   ;
...
CREATE TABLE "admin_role_permissions" (
  ...
  "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP) =44   ;
...
CREATE TABLE "barangays" (
  ...
  "updated_at" timestamp NULL DEFAULT NULL) =1217  ;
...
CREATE TABLE "crime_analytics" (
  ...
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =27  ;
...
CREATE TABLE "crime_forecasts" (
  ...
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =26  ;
...
CREATE TABLE "locations" (
  ...
  "station_id" bigint  DEFAULT NULL,
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =14434  ;
...
CREATE TABLE "messages" (
  ...
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =41  ;
...
CREATE TABLE "notifications" (
  ...
  "updated_at" timestamp NULL DEFAULT CURRENT_TIMESTAMP) =35  ;
...
CREATE TABLE "police_officers" (
  ...
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =14  ;
...
CREATE TABLE "report_ip_tracking" (
  ...
  "user_agent" text ,
  "submitted_at" timestamp NULL DEFAULT CURRENT_TIMESTAMP ) =15   ;
...
CREATE TABLE "reports" (
  ...
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =14435  ;
...
CREATE TABLE "role_route" (
  ...
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =112  ;
...
CREATE TABLE "user_admin" (
  ...
  "last_failed_login" timestamp NULL DEFAULT NULL) =36   ;
...
CREATE TABLE "user_admin_roles" (
  ...
  "assigned_by" bigint  DEFAULT NULL) =13   ;
...
CREATE TABLE "user_flags" (
  ...
  "created_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  "updated_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP) =29  ;
...
CREATE TABLE "user_role" (
  ...
  "role_id" bigint  NOT NULL,
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =3  ;
...
CREATE TABLE "users_public" (
  ...
  "failed_login_attempts" int NOT NULL DEFAULT '0',
  "lockout_until" timestamp NULL DEFAULT NULL,
  "last_failed_login" timestamp NULL DEFAULT NULL) =38   ;
...
CREATE TABLE "verifications" (
  ...
  "is_verified" SMALLINT NOT NULL DEFAULT '0' ,
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL) =11  ;
